...
const Konsultasi = () => {
  ...
  const dataCategories = {
    "": [
      {
        id: 1,
        link1: "https://wa.me/083192973492",
        content1: "Whatshap 1",
        link2: "https://wa.me/085156644103",
        content2: "Whatshap 2",
        image: require("../../assets/profile.png"),
      },
      {
        id: 2,
        link1: "https://wa.me/082231704029",
        content1: "Whatshap 1",
        link2: "https://wa.me/083192973492",
        content2: "Whatshap 2",
        image: require("../../assets/profile.png"),
      },
    ],
      ...
      <ScrollView backgroundColor={"white"} width={"100%"} height={"100%"}>
        <View mx={"7"}>
          ...
          <VStack space={2} marginLeft={1}>
            ...
            {Object.entries(dataCategories).map(
                  ...
                  <HStack space={2}>
                    {sectionData.map((box, index) => (
                      ...
                      >
                        ...
                        />
                        <TouchableOpacity
                          onPress={() => handleLinkClick(box.link1)}
                        >
                          <Text color="white">{box.content1}</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                          onPress={() => handleLinkClick(box.link2)}
                        >
